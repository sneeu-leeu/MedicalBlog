...
comment2 = Comment.create(text: 'Comment2 Sed suscipit sodales libero vligula porta accumsan.', user: second_user,
                          post: post2)
comment3 = Comment.create(text: 'Comment3 faucibus scelerisque sapiennim eu, tristiquee et consequat',
                          user: third_user, post: post3)
comment4 = Comment.create(text: 'Comment4 Class aptent taciti sociosqu adeptos himenaeos. Pellentesque nunc dolor,',
                          user: fourth_user, post: post3)
comment5 = Comment.create(
  text: 'Comment5  Sed suscipit sodales libero vel mollis. Aenean euismod lm dapibus odio nec sapien rhoncus, ve', user: fifth_user, post: post1
)
comment6 = Comment.create(text: 'Comment6 get viverra commodo. Proin aliquet augue id felis pharetra, ',
